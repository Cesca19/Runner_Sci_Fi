...
void FOnDeath_DelegateWrapper(const FMulticastScriptDelegate& OnDeath)
{
	...
	DEFINE_FUNCTION(ARunCharacter::execGetWeaponAmmo)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(int32*)Z_Param__Result=P_THIS->GetWeaponAmmo();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(ARunCharacter::execGetWeaponName)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(ARunCharacter::execGetMaxAmmo)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(ARunCharacter::execAddAmmo)
	{
		P_GET_PROPERTY(FIntProperty,Z_Param_number);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->AddAmmo(Z_Param_number);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(ARunCharacter::execGetWeapon)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(AWeapon**)Z_Param__Result=P_THIS->GetWeapon();
		P_NATIVE_END;
	}
	...
	void ARunCharacter::StaticRegisterNativesARunCharacter()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "AddAmmo", &ARunCharacter::execAddAmmo },
			...
			{ "GetMaxAmmo", &ARunCharacter::execGetMaxAmmo },
	...
	struct Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics
	{
		struct RunCharacter_eventAddAmmo_Parms
		{
			int32 number;
		};
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics::NewProp_number = { "number", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RunCharacter_eventAddAmmo_Parms, number), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics::NewProp_number,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/RunCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ARunCharacter, nullptr, "AddAmmo", nullptr, nullptr, Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics::PropPointers), sizeof(Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics::RunCharacter_eventAddAmmo_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics::Function_MetaDataParams), Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics::RunCharacter_eventAddAmmo_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ARunCharacter_AddAmmo()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ARunCharacter_AddAmmo_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_ARunCharacter_AddWeapon_Statics::NewProp_type = { "type", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RunCharacter_eventAddWeapon_Parms, type), Z_Construct_UClass_UClass, Z_Construct_UClass_AWeapon_NoRegister, METADATA_PARAMS(0, nullptr) };
	...
	struct Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics
	{
		struct RunCharacter_eventGetMaxAmmo_Parms
		{
			int32 ReturnValue;
		};
		static const UECodeGen_Private::FIntPropertyParams NewProp_ReturnValue;
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RunCharacter_eventGetMaxAmmo_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/RunCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ARunCharacter, nullptr, "GetMaxAmmo", nullptr, nullptr, Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics::PropPointers), sizeof(Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics::RunCharacter_eventGetMaxAmmo_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics::Function_MetaDataParams), Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics::RunCharacter_eventGetMaxAmmo_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ARunCharacter_GetMaxAmmo()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ARunCharacter_GetMaxAmmo_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics
	{
		struct RunCharacter_eventGetWeapon_Parms
		{
			AWeapon* ReturnValue;
		};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RunCharacter_eventGetWeapon_Parms, ReturnValue), Z_Construct_UClass_AWeapon_NoRegister, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/RunCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ARunCharacter, nullptr, "GetWeapon", nullptr, nullptr, Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics::PropPointers), sizeof(Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics::RunCharacter_eventGetWeapon_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics::Function_MetaDataParams), Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics::RunCharacter_eventGetWeapon_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ARunCharacter_GetWeapon()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ARunCharacter_GetWeapon_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics
	{
		struct RunCharacter_eventGetWeaponAmmo_Parms
		{
			int32 ReturnValue;
		};
		static const UECodeGen_Private::FIntPropertyParams NewProp_ReturnValue;
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RunCharacter_eventGetWeaponAmmo_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/RunCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ARunCharacter, nullptr, "GetWeaponAmmo", nullptr, nullptr, Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics::PropPointers), sizeof(Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics::RunCharacter_eventGetWeaponAmmo_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics::Function_MetaDataParams), Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics::RunCharacter_eventGetWeaponAmmo_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ARunCharacter_GetWeaponAmmo_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics
	{
		struct RunCharacter_eventGetWeaponName_Parms
		{
			FString ReturnValue;
		};
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(RunCharacter_eventGetWeaponName_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/RunCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ARunCharacter, nullptr, "GetWeaponName", nullptr, nullptr, Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics::PropPointers), sizeof(Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics::RunCharacter_eventGetWeaponName_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics::Function_MetaDataParams), Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics::RunCharacter_eventGetWeaponName_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ARunCharacter_GetWeaponName()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ARunCharacter_GetWeaponName_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ARunCharacter_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ARunCharacter_AddAmmo, "AddAmmo" }, // 3263116408
		...
		{ &Z_Construct_UFunction_ARunCharacter_GetMaxAmmo, "GetMaxAmmo" }, // 278332155
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ARunCharacter_Statics::NewProp_OnDeath = { "OnDeath", nullptr, (EPropertyFlags)0x0010000010080001, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ARunCharacter, OnDeath), Z_Construct_UDelegateFunction_RunnerOutbreak_OnDeath__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ARunCharacter_Statics::NewProp_OnDeath_MetaData), Z_Construct_UClass_ARunCharacter_Statics::NewProp_OnDeath_MetaData) }; // 260579771
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ARunCharacter_Statics::NewProp_Weapon_MetaData[] = {
		{ "Category", "RunCharacter" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/RunCharacter.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ARunCharacter_Statics::NewProp_Weapon = { "Weapon", nullptr, (EPropertyFlags)0x00200800000a001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ARunCharacter, Weapon), Z_Construct_UClass_UChildActorComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ARunCharacter_Statics::NewProp_Weapon_MetaData), Z_Construct_UClass_ARunCharacter_Statics::NewProp_Weapon_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ARunCharacter_Statics::NewProp_PlayerMesh_MetaData[] = {
		{ "Category", "RunCharacter" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/RunCharacter.h" },
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_fifam_Projets_G_TECH3_Unreal_C___BP_Runner_Sci_Fi_RunnerOutbreak_Source_RunnerOutbreak_Public_RunCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ARunCharacter, ARunCharacter::StaticClass, TEXT("ARunCharacter"), &Z_Registration_Info_UClass_ARunCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARunCharacter), 3421380119U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_fifam_Projets_G_TECH3_Unreal_C___BP_Runner_Sci_Fi_RunnerOutbreak_Source_RunnerOutbreak_Public_RunCharacter_h_331281675(TEXT("/Script/RunnerOutbreak"),
